  ...
  return (
    <div className="mainDiv">
        <div className="formDiv">
            ...
            <input name='Förnamn' id="textInput" type="text" required minLength={1} />
            <label id="inputLabel" htmlFor="Förnamn">Förnamn</label>

            <input name='Efternamn' id="textInput" type="text" required minLength={1} />
            <label id="inputLabel" htmlFor="Efternamn">Efternamn</label>

            <input name='Mail' id="textInput" type="text" required minLength={1} />
            <label id="inputLabel" htmlFor="Mail">Mail</label>

            <input name='Telefonnummer' id="textInput" type="text" required minLength={1} />
            <label id="inputLabel" htmlFor="Telefonnummer">Telefonnummer</label>

            <input name='Adress' id="textInput" type="text" required minLength={1} />
